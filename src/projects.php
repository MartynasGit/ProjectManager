    ...
    <tbody>
        ...
        if (!empty($projectsArray)) {
            foreach ($projectsArray as $project) {
                ...
                echo '<td><a href="' . $_SERVER['PHP_SELF'] . '?path=edit_project&id=' . $project['id'] . '" class="btn btn-primary me-2">' . '<i class="bi bi-pencil-square me-1"></i></a>';
                echo '<a href="' . $_SERVER['PHP_SELF'] . '?path=delete_project&id=' . $project['id'] . '" class="btn btn-primary">' . '<i class="bi bi-trash3-fill me-1"></i></i></a></tr>';
            }
        } else {
