...
CREATE TABLE `employees` (
  ...
  PRIMARY KEY (`id`),
  KEY `employees` (`project_id`),
  CONSTRAINT `employees` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `projects` VALUES (1,'NASA'),(2,'Tesla'),(3,'PHP '),(4,'Reddit');
...
-- Dump completed on 2022-09-25 21:55:17
